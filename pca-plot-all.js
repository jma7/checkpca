	var node = document.getElementById("pca-div");
	var legendNode = document.getElementById("legend-display");
	...
	function PcaPlot(model, params) {
	    ...
	    function redrawExtraInfo() {
	        ...
	        var lineArray = [
	            ["FVE: ", formatter((+fractionalVariances[xDimension] + +fractionalVariances[yDimension]) * 100) + " %"]
	        ];
	    ...
	    function findAndHiliteLegend(targetBatch) {
	        ...
	        var legend = d3.select("svg.batchlegend"); // ### Needs to be more focused  // ###select legend
	...
	function riskGradient(config) {
	    ...
	    function makeMeter() {
	        ...
	        var ticks = (new Date()).getTime(), // used to make ID for elements below
	            suffix = '' + ticks, // i.e. toString
	            gradientID = 'riskGradient' + suffix,
	            startArrowID = 'start-arrowhead' + suffix,
	            arrowID = 'arrowhead' + suffix;
	        ...
	        scalingGroup.append('svg:text')
	            .attr("text-anchor", "end")
	            .attr('transform', 'translate(25,73) rotate(-90)') // was at x25, y90
	            .text('High');
	        scalingGroup.append('svg:text')
	            .attr("text-anchor", "end")
	            .attr('transform', 'translate(25,169) rotate(-90)') // was at x25, y170
	            .text('Low');
	        ...
	        scalingGroup.append("svg:line")
	            ...
	            .attr("stroke-width", "2")
	            .style("stroke", "black")
	            .attr("marker-start", 'url(#' + startArrowID + ')')
